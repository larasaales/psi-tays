...
const DEFAULT_MSG = encodeURIComponent('Olá! Vim através do site e gostaria de saber mais sobre as sessões de terapia e horários disponíveis.');
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            <nav className="flex gap-6 text-sm font-medium text-gray-600">
              ...
              <Link href="#especialidades" className="hover:text-[#6D4958] transition-colors">Especialidades</Link>
      ...
      {/* Como a Terapia Pode Ajudar / Especialidades */}
      <section id="especialidades" className="py-20 md:py-28 px-6 bg-white relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h3 className="font-serif text-3xl md:text-4xl text-[#333] mb-4">Como a terapia pode te ajudar?</h3>
            <p className="text-gray-600">A psicoterapia clínica é uma ferramenta valiosa para lidar com diversas questões da nossa vida.</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <Brain className="w-8 h-8" style={{ color: THEME.secondary }} />,
                title: "Ansiedade e Estresse",
                desc: "Aprenda estratégias para gerenciar crises, medos constantes e o excesso de preocupação com o futuro."
              },
              {
                icon: <Heart className="w-8 h-8" style={{ color: THEME.secondary }} />,
                title: "Autoestima e Autocuidado",
                desc: "Desenvolva uma relação mais gentil e positiva com você mesmo, fortalecendo sua confiança e valor próprio."
              },
              {
                icon: <ShieldCheck className="w-8 h-8" style={{ color: THEME.secondary }} />,
                title: "Transições e Lutos",
                desc: "Acolhimento para momentos de perda, mudanças bruscas na carreira, vida pessoal ou relacionamentos."
              }
            ].map((item, idx) => (
              <motion.div 
                key={idx}
                ...
                className="p-8 rounded-3xl bg-[#FCFCFB] border border-gray-100 shadow-sm hover:shadow-md transition-shadow group"
              >
                ...
                <h4 className="text-xl font-serif text-[#333] mb-3">{item.title}</h4>
          ...
          <div className="mt-16 text-center">
             <a  href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#6D4958] font-medium hover:underline">
               Tem alguma dúvida se a terapia é para você? Vamos conversar. <ArrowRight size={18}/>
             </a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="grid sm:grid-cols-2 gap-8 text-left">
            <div className="p-8 rounded-3xl bg-gray-50 border border-gray-100 flex flex-col h-full">
              ...
              <p className="text-gray-600 flex-grow">As sessões têm duração média de 50 minutos. Os atendimentos podem ser online para todo o Brasil ou presenciais em Fortaleza.</p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-gray-50 border border-gray-100 flex flex-col h-full">
              ...
              <p className="text-gray-600 flex-grow">Os atendimentos são guiados por um profundo respeito à individualidade de cada pessoa, pautados no estrito sigilo ético profissional.</p>
            </div>
          </div>
        </div>
      </section>
